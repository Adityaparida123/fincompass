...
export function FinAIChat() {
  ...
  return (
    <>
      {!isOpen && (
        <button
          className="fab-chat fixed bottom-6 right-6 z-[60] h-12 w-12 rounded-full bg-primary text-primary-foreground shadow-lg lg:bottom-6 lg:right-6 flex items-center justify-center"
